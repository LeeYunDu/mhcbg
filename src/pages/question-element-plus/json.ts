...
export const tableColumn: FieldItem[] = [
  { label: '问卷标题', key: 'questionTitle', },
  { label: '问卷描述', key: 'description', type: 'slot', slotName: 'description' },
  { label: '创建人', key: 'createdByName', width: '150px' },
...
export const formFields = [
  {
    label: '问卷标题', key: 'questionTitle', type: 'input',
    props: {
      gridItem: { span: 24 },
      ...
      placeholder: '请输入问卷标题,限100字内',
    },
  },
  {
    label: '评分维度', key: 'scoringSystem', type: 'select', options: get(dictData, 'dict_questionnaire_score_system.list', []),
    props: {
      gridItem: { span: 24 },
      formItem: { required: true },
      clearable: true,
...
export const questionFormFields = [
  ...
  {
    label: '问题描述', key: 'title', type: 'input',
    props: {
      gridItem: { span: 24 },
      formItem: { required: true },
      clearable: true,
