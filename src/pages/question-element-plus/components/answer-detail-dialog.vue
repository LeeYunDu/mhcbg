  ...
  >
    <div class="answer-detail-container">
        ...
        <el-row :gutter="20">
          ...
          <el-col :span="8">
            <div class="info-item">
              ...
              <span class="info-value">{{ state.data.sessionId }}</span>
            </div>
          </el-col>
          <el-col :span="8">
            <div class="info-item">
              <label class="info-label">回答状态</label>
              <el-tag :type="state.data.answerStatus === 1 ? 'success' : 'warning'">
                {{ state.data.answerStatus === 1 ? '已完成' : '未完成' }}
              </el-tag>
            </div>
          </el-col>
        </el-row>
      ...
      <div class="answer-content">
        <h3 class="content-title">用户填写问卷记录</h3>
        <el-table
